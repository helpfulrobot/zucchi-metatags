						...
						<ul>
							<li>file titles to...
								<ul>
									...
									<li><a href="{$Link}recycleall/" class="recycle ajaxify" rel="Title">recycle all un-used files</a></li>
									<li><a href="{$Link}updatefilenames/" class="updatefilenames ajaxify" rel="Title">guess file names</a></li>
								</ul>
							</li>
						</ul>
					</td>
